...
if (isset($_GET['maloai']) && is_numeric($_GET['maloai'])) {
    $maloai = (int)$_GET['maloai'];

    // Lấy tên loại để hiển thị
    $stmt = $conn->prepare("SELECT TenLoai FROM Loai WHERE MaLoai = ?");
    ...
    if (!$loai) {
        echo "<h2>Không tìm thấy danh mục!</h2>";
        exit();
    }

    //echo "<h2>Sản phẩm thuộc danh mục: " . htmlspecialchars($loai['TenLoai']) . "</h2>";
    ...
    echo "<h2>Không có danh mục được chọn!</h2>";
}
?>
...
<body>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center text-black mb-12">Sản phẩm thuộc danh mục: "<?= htmlspecialchars($loai['TenLoai']) ?>"</h2>
                    ...
                    <div class="product-card bg-white rounded-lg overflow-hidden shadow-lg transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button class="bg-amber-600 hover:bg-amber-700 text-white px-2 py-2 rounded transition duration-300">
                                    Thêm vào giỏ
                                </button>
                            </div>
                        </div>
